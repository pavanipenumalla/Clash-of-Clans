...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, spawnStarcher, move_starchers, spawnHealer, move_healers
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnStarcher(V.spawn_points[0])
    elif ch == '3':
        spawnStarcher(V.spawn_points[1])
    elif ch == '4':
        spawnStarcher(V.spawn_points[2])
    elif ch == '5':
